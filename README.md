...
The release will include dataset documentation, download instructions, data formats, and evaluation protocols.
...
* Localization performance in large-scale indoor environments
* Generalization from existing residential-scale datasets
* The effect of fine-tuning on representative large-scale data
* Localization under structural repetition and spatial ambiguity
* Performance across different observation and temporal settings

Benchmarking code, evaluation scripts, and baseline instructions will be released in this repository.
...
More detailed dataset statistics and collection methodology will be provided with the release.
...
Evaluation tools and instructions for reproducing the benchmark will be released soon.
...
For questions about the dataset or benchmark, please open an issue in this repository.
